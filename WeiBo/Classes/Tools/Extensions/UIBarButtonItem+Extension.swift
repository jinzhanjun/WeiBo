...
extension UIBarButtonItem {
    ...
    ///   - action: 监听方法
    ///   - event: 触发事件
    convenience init(title: String, fontSize: CGFloat = 16, normalColor: UIColor = UIColor.systemBlue, highlightedColor: UIColor = UIColor.orange, target: Any?, action: Selector, event: UIControl.Event) {
